...
class Human:
    ...
    def days_indexes(self, day):
        ...
        print(f"{h_i:=^50}\n")
        # Вивести значення атрибутів рівня обєекту класу Human 3
        home_i = "Home indexes"
        print(f"{home_i:=^50}\n")
        # Вивести значення атрибутів рівня обєкту класу House 2
        car_ind = f"{self.car.brand} car indexes"
        print(f"{car_ind:=^50}\n")
        # Вивести значення атрибутів рівня обєкту класу Auto 2
